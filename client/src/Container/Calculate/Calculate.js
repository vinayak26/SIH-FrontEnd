    ...
    <div className="Calculate-Container">
      ...
      <div>
        ...
        >
          ...
          <option value="SAVANA 1500 CARGO AWD">SAVANA 1500 CARGO AWD</option>
          ...
          <option value="SAVANA 1500 CARGO CONV">SAVANA 1500 CARGO CONV</option>
          ...
          <option value="CHEROKEE TRAILHAWK 4X4">CHEROKEE TRAILHAWK 4X4</option>
          <option value="OPTIMA">OPTIMA</option>
          <option value="WRANGLER UNLIMITED 4X4 (4-DOOR)">
            WRANGLER UNLIMITED 4X4 (4-DOOR)
          </option>
          <option value="WRANGLER 4X4 (2-DOOR)">WRANGLER 4X4 (2-DOOR)</option>
          <option value="PATRIOT 4X4">PATRIOT 4X4</option>
          <option value="GRAND CHEROKEE 4X4 FFV">GRAND CHEROKEE 4X4 FFV</option>
          ...
          <option value="JETTA TDI CLEAN DIESEL">JETTA TDI CLEAN DIESEL</option>
          ...
          <option value="EXPRESS 1500 CARGO AWD">EXPRESS 1500 CARGO AWD</option>
          ...
          <option value="GL 350 BLUETEC 4MATIC">GL 350 BLUETEC 4MATIC</option>
          ...
          <option value="ML 350 BLUETEC 4MATIC">ML 350 BLUETEC 4MATIC</option>
          <option value="GLK 250 BLUETEC 4MATIC">GLK 250 BLUETEC 4MATIC</option>
          ...
          <option value="E 63 AMG 4MATIC WAGON">E 63 AMG 4MATIC WAGON</option>
          ...
          <option value="650i xDRIVE CABRIOLET">650i xDRIVE CABRIOLET</option>
          ...
          <option value="RANGE ROVER V8 5.0 SC">RANGE ROVER V8 5.0 SC</option>
          <option value="RANGE ROVER V6 3.0 SC">RANGE ROVER V6 3.0 SC</option>
      ...
      {/* MILEAGE */}
      <div>
        <label htmlFor="Mileage in Km/L">Mileage in Km/L:</label>
        <input
